...
All code, input files, and example outputs necessary to reproduce the results presented in this manuscript are publicly available.  
The full project repository (LaTeX source, BibTeX file, numerical solver, plotting scripts and figures) is hosted on GitHub: \url{https://github.com/scikyrollesashraf/complex-dm-two-state}.  
A frozen, citable release of the repository has been archived on Zenodo (DOI): \href{https://doi.org/10.5281/zenodo.17772500}{10.5281/zenodo.17772500}.  

Reproduction instructions: clone the GitHub repository, install the Python requirements listed in the README (e.g., \texttt{numpy}, \texttt{scipy}, \texttt{matplotlib}), and run \texttt{boltzmann_full_solver.py}see the repository README for exact commands and example parameter files.
For large data files or additional simulation outputs not included in the main repository, please contact the corresponding author at \texttt{kyrls.dawd1231@science.aun.edu.eg}.
\section{License}
...
\begin{itemize}
  ...
  \item Citable archived release (Zenodo DOI): \href{https://doi.org/10.5281/zenodo.17772500}{10.5281/zenodo.17772500}
